@AbapCatalog.sqlViewName: 'ZIPURDOCITEM_FF'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Purchase Document Item'

define view Z_I_PurchaseDoc_Item_ff
  as select from zpurdocitem_ff
  association [1..1] to Z_I_PurchaseDoc_ff as _PurchaseDocument      on $projection.PurchaseDocument = _PurchaseDocument.purchasedocument
  ...
  association [0..1] to Z_I_VENDORTYPE_FF  as _VendorType            on $projection.VendorType = _VendorType.VendorType
