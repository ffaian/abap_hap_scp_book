@AbapCatalog.sqlViewName: 'ZIPURDOCUFF'
...
define root view Z_I_PurDocument_ff_U  as select from Z_I_PurchDocOvPrice_FF
  composition [0..*] of Z_I_PurchaseDoc_Item_ff_U as _PurchaseDocumentItem
